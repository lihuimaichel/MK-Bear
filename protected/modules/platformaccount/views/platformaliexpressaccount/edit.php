...
<div class="pageContent"> 
    ...
    $form = $this->beginWidget('ActiveForm', array(
        ...
        'action' => Yii::app()->createUrl("/platformaccount/platformaliexpressaccount/edit", array('id'=>$model->id)),
        'htmlOptions' => array(        
            'class' => 'pageForm',         
        )
    ));
    ...
    <div class="pageFormContent" layoutH="56"> 
        ...
        <div class="pd5" style="height:180px;">
        	<div class="row">
	        	...
	        	<?php echo $form->textField($model, 'short_name',array('size'=>28,'maxlength'=>128,'empty'=>"不能为空")); ?>
