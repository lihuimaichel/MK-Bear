...
<div class="pageContent"> 
    ...
    <div class="pageFormContent" layoutH="56"> 
        <div class="pd5" style="height:200px;">
            <input id="PlatformAliexpressAccount_ID" value="<?php echo $model->id; ?>" type="hidden" class="textInput">
            <div class="row">
                <?php echo $form->labelEx($model, 'email'); ?>
                <?php echo $form->textField($model, 'email',array('size'=>48, 'disabled'=>'disabled')); ?>
...
$("document").ready(function(){
    ...
    function authorization(){
        ...
        var postData = {'id':id, 'redirect_uri':redirectUri};
        var url = '<?php echo Yii::app()->createUrl('/platformaccount/platformaliexpressaccount/reauthorization')?>';
