...
<div class="pageContent"> 
    ...
    <div class="pageFormContent" layoutH="56"> 
        <div class="pd5" style="height:200px;">
            <input id="PlatformWishAccount_ID" value="<?php echo $model->id; ?>" type="hidden" class="textInput">
            <div class="row">
            ...
            <div class="row" style="overflow:hidden;padding-left:220px;">
                <div class="button"><div class="buttonContent"><button type="button" onclick="authorization()">保存并输入token</button></div></div>
            </div>
...
<script type="text/javascript">
    function authorization(){
        ...
        var postData = {'id':id};
        var url = '<?php echo Yii::app()->createUrl('/platformaccount/platformwishaccount/reauthorization')?>';
