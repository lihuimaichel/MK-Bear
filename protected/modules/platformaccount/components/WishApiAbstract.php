...
abstract class WishApiAbstract implements PlatformApiInterface {
    ...
    public function setAccount($accountID){
        $accountInfo                = PlatformWishAccount::getWishAccountInfoById($accountID);//获取账号相关信息
        ...
        $this->_tokenExpiredTime    = $accountInfo['token_invalid_time'];
        $this->_baseUrl             = $wishKeys['baseUrl'];
        // $this->_authorizationUrl    = $wishKeys['authorizationUrl'];
