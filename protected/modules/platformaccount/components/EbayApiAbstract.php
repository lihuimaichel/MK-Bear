...
abstract class EbayApiAbstract implements PlatformApiInterface {
    ...
    /**@var string 授权地址*/
    protected $_authorizationUrl = null;
    ...
    public function setAccount($accountID){
        ...
        //获取账号相关信息
        $accountInfo = PlatformEbayAccount::getEbayAccountInfoById($this->accountID);
        ...
        $this->_authorizationUrl = $ebayKeys['authorizationUrl'];
        return $this;
    }
    ...
    public function sendRequest() {
        try {
            $ebayAPI = new EbaySession($this->_usertoken, $this->_devID, $this->_appID, $this->_certID, $this->_serverUrl, $this->_compatLevel, $this->_siteID, $this->_verb, $this->_callType, $this->_boundary);
