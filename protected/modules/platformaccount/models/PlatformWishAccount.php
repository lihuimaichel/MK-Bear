 ...
 * @since 2017-02-27
 */
class PlatformWishAccount extends PlatformAccountModel{
    ...
    public function tableName() {
        return 'ueb_platform_wish_account';
    }   
    ...
    public function addtions($datas){
        ...
        foreach ($datas as &$data){
            $depID = $this->getDeparment($data['department_id'], 'wish');
            if(is_array($depID)){
                $data['department_id'] = '';
            }else{
    ...
    public function filterOptions() {
        ...
        $result = array(
                ...
                array(
                        ...
                        'type'=>'dropDownList',
                        'search'=>'=',
                        'data'=>$this->getDeparment(null, 'wish'),
                        'value'=>$departmentId
                ),
        );
        return $result;
    ...
    public static function getIndexNavTabId() {
        return Menu::model()->getIdByUrl('/platformaccount/platformwishaccount/list');
    }
     ...
     * @return boolean
     */
    public function wishAccountAuthorize($accountId, $redirectUri){
        $request = new GetWishAccountCodeRequest();
    ...
    public function isAccessTokenEffective($accountID){
        $isEffective = false;
        $request = new WishListAllProductsRequest();
