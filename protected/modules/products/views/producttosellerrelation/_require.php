...
<table class="dataintable_inquire" width="100%" cellspacing="1" cellpadding="3" border="0">
	<thead>
    	<tr>
            <td colspan='3'>
           <a href="/products/product/list/target/dialog" id='add_keys' target='dialog' mask='true' onclick='show(this);' width='600' height='650'>
            <button style="float:left;" type="button"><?php echo Yii::t('products', 'Select product')?></button>
            </a>
            </td>
...
<script>
	...
	function show(){
		...
		$('#add_keys').attr('href','/products/product/list/target/dialog/type/producttoseller/key/'+key);
	}
</script>
