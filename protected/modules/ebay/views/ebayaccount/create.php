    ...
    <div class="pageFormContent" layoutH="56"> 
        ...
        <div class="pd5" style="height:180px;">
            ...
            <div class="row">
	            ...
	            <?php echo $form->textField($model, 'store_name',array('size'=>28,'maxlength'=>128));?>
	            <?php echo $form->error($model, 'store_name'); ?>
        	</div>
            <div class="row">
	            <?php echo $form->labelEx($model, 'short_name'); ?>
	            <?php echo $form->textField($model, 'short_name',array('size'=>28,'maxlength'=>128));?>
        	...
        	<div class="row">
        		...
        		<?php echo $form->dropDownList($model, 'store_site', EbaySite::getSiteList(),array('empty'=>Yii::t('system', 'Please Select')));?>
        		<?php echo $form->error($model,'store_site');?>
        	</div>
        	<div class="row">
	            <?php echo $form->labelEx($model, 'use_status'); ?>
	            <?php echo $form->dropDownList($model, 'status',UebModel::model('Ebayaccountmanage')->getAccountStatus(),array('empty'=>Yii::t('system', 'Please Select')));?>
        ...
        <div class="pd5" style="height:150px;">
	        ...
	        <div class="row">
	        	...
	        	<?php echo $form->radioButton($model, 'is_auto_upload', array('size'=>28,'maxlength'=>128, 'value'=>1, 'checked'=>'checked')); ?><span>是</span>
