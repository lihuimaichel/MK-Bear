...
<div class="pageContent"> 
    ...
    $form = $this->beginWidget('ActiveForm', array(
        ...
        'action' => Yii::app()->createUrl("/ebay/ebayproductsellerrelation/savedata", array('id'=>$model->id)),
        'htmlOptions' => array(        
            'class' => 'pageForm',         
        )
    ));
    ...
    <div class="pageFormContent" layoutH="56"> 
        ...
        <div class="pd5" style="height:200px;">
            ...
            <div class="row">
                <label for="item_id">站点</label>
                <input type="text" id="site_id" value="<?php echo $model->site_name;?>" readonly/>
            </div>
         	<div class="row">
