            ...
            <li>
                <div class="buttonActive">
                    <div class="buttonContent">
                        <a rel="" href="<?php echo Yii::app()->createUrl('ebay/ebayproductadd/productaddstepsecond');?>" target="navTab" id="product_add_next_btn" style="display:none;">
                            <?php echo Yii::t('ebay', 'Choose Add Info')?>
                        </a>
                    </div>
                </div>
            </li>
...
$('#product_add_next_btn').click(function(){
	$(this).attr('href','ebay/ebayproductadd/productaddstepsecond/sku/'+$('#product_add_sku').val());
	$('.dialog .close').click();
});
</script>
<?php else: ?>
