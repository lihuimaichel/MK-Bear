    ...
    <div class="pageFormContent" layoutH="56"> 
        <div class="pd5" style="height:150px;">
            <div class="row">
                ...
                <?php echo $form->textField($model,'site_id', array('size' => '20',)); ?>
                <?php echo $form->error($model, 'site_id',array('style'=>'float:right;')); ?> 
            </div>
        	<div class="row">
                <?php echo $form->labelEx($model, 'site_name'); ?>
                <?php echo $form->textField($model,'site_name', array('size' => '20',)); ?>
                <?php echo $form->error($model, 'site_name',array('style'=>'float:right;')); ?> 
            </div>
            <div class="row">
