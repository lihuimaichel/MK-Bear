 ...
 * 设置销售人员销售额任务
 */
class EbaySalesTarget extends EbayModel
{
	const TARGET = 50000;
	...
	{
		return 'ueb_ebay_task_sales_target';
	}


	public function deleteOne($uid, $account_id, $site)
	{
		$result = Yii::app()->db_ebay->createCommand()
			->delete(
				$this->tableName(),
	...
	{
		$list = Yii::app()->db_ebay->createCommand()
	...
	{
		$rows = EbaySalesExtend::model()->getDataByCondition('*', " sales_id = '{$id}'");
		return $rows;
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'account_id' => Yii::t('ebay', 'Accounts'),
