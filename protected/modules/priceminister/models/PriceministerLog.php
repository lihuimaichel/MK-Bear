 ...
 * @since 2016-07-14
 */ 
class PriceministerLog extends PriceministerModel{
    ...
    /** @var 补拉订单 */
    const EVENT_PULL_ORDER = 'pullorder';
    ...
    public function getAccountList(){
            if(self::$accountPairs == null)
                    self::$accountPairs = self::model('PriceministerAccount')->getIdNamePairs();
