 ...
 * 设置销售人员销售额任务
 */
class WishSalesTarget extends WishModel
{
	const TARGET = 50000;
	...
	{
		return 'ueb_wish_task_sales_target';
	}
	...
	public static function remove($uid, $ids)
	{
		...
		$result = Yii::app()->db_wish->createCommand()
			->delete(
				self::tableName(),
	...
	{
		$rows = WishSalesExtend::model()->getDataByCondition('*', " sales_id = '{$id}'");
		return $rows;
	}
