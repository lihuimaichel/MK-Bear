            ...
            <li>
                <div class="buttonActive">
                    <div class="buttonContent">
                        <a rel="" href="<?php echo Yii::app()->createUrl('');?>" target="navTab" id="product_add_next_btn" style="">
                            <?php echo Yii::t('wish_listing', 'Wish Choose Add Info')?>
                        </a>
                    </div>
                </div>
            </li>
...
$('#product_add_next_btn').click(function(){
	$(this).attr('href','wish/wishproductadd/add/sku/'+$('#product_add_sku').val());
	$('.dialog .close').click();
});
</script>
<?php else: ?>
