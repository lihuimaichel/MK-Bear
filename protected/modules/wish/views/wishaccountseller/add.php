...
<?php
    $form = $this->beginWidget('ActiveForm', array(
        ...
        'action' => '/wish/wishaccountseller/add',
        'htmlOptions' => array(        
            'class' => 'pageForm',         
        )
    ));
    ...
    <div class="pageFormContent" layoutH="56"> 
        <div class="pd5" style="height:120px;">
            <div class="row">
                ...
                <?php  echo $form->dropDownList($model,'seller_user_id',$sellerList, array('empty'=>"请选择"));?>
        	...
        	<div class="row" id="accountListAll">
                ...
                <span><input name="WishAccountSeller[account_id][]" type="checkbox" value="<?php echo $id; ?>" /><?php echo $accout; ?></span>
                <?php endforeach;?>
                <?php endif;?>
        	</div>
...
$(document).ready(function(){
    //触发了要发布的账号
    $("#WishAccountSeller_seller_user_id").change(function(){
        var selectedId = $(this).find("option:selected").val();
        if (selectedId){
            var ajaxurl ='/wish/wishaccountseller/ajaxdata/seller_id/' + selectedId;
