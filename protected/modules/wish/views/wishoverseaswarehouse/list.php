...
$this->widget('UGridView', array(
	'id' => 'wishoverseaswarehouse-grid',
	'dataProvider' => $model->search(null),
	'filter' => $model,
		'toolBar' => array(	
				array(
						'text' => Yii::t('wish_product_statistic', 'Import Excel'),
						'url' => Yii::app()->createUrl('/wish/wishoverseaswarehouse/touploadfile'),
						'htmlOptions' 	=> array(
								'class' 	=> 'add',
								'target' 	=> 'dialog',
								'mask'		=> true,
								'rel' 		=> 'wishoverseaswarehouse-grid',
								'width' 	=> '500',
								'height' 	=> '300',
								'onclick' 	=> '',
						)
				...
				array(
						...
						'url' => Yii::app()->createUrl('/wish/wishoverseaswarehouse/downloadtp'),
						'htmlOptions' 	=> array(
								'class' 	=> 'icon',
								'target' 	=> '_blank',
								'mask'		=> true,
				...
				array(
						...
						'url' => Yii::app()->createUrl('/wish/wishoverseaswarehouse/delete'),
						'htmlOptions'   => array(
								'class'     => 'delete',
				...
				array(
						...
						'url' => Yii::app()->createUrl('/wish/wishoverseaswarehouse/outfile?'.$request),
						'htmlOptions' 	=> array(
	...
	'columns' => array(
			...
			array(
					...
					'buttons' => array(
							'edit' => array(
									'url'       => 'Yii::app()->createUrl("/wish/wishoverseaswarehouse/update", array("id" => $data->id))',
