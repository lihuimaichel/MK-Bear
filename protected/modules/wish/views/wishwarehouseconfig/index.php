	    ...
	    <div class="dot7" style="padding:5px;">
	       ...
	       <?php
            $form = $this->beginWidget('ActiveForm', array(
                ...
                'action' => Yii::app()->createUrl('wish/wishwarehouseconfig/savedata'), 
                'htmlOptions' => array(        
                    'class' => 'pageForm',         
                )
            ));
            ?> 
            	<div class="formBar">
                    <ul> 
                        ...
                        <a href="<?php echo Yii::app()->createUrl('wish/wishwarehouseconfig/index');?>" target="navTab" style="display:none;" class="display_list"><?php echo Yii::t('system', 'Save');?></a>
                    </ul>
                </div>
...
function saveInfo(){
	$.ajax({
			type: 'post',
			url: $('form#wish_warehouse_config_add').attr('action'),
			data:$('form#wish_warehouse_config_add').serialize(),
