...
$row = 0;
$options = array(
	'id' => 'wishproductsellerrelation-grid',
	...
	'toolBar' => array(
			...
			array (
					...
					'url' => '/wish/wishproductsellerrelation/batchchangetoseller',
					'htmlOptions' => array (
							'class' => 'add',
							'target' => 'dialog',
							'rel' => 'wishproductsellerrelation-grid',
			...
			array (
					...
					'url' => '/wish/wishproductsellerrelation/batchdel',
					'htmlOptions' => array (
							'class' => 'delete',
							'target' => 'selectedToDo',
							'rel' => 'wishproductsellerrelation-grid',
			...
			array (
					...
					'url' => '/wish/wishproductsellerrelation/unbindseller',
					'htmlOptions' => array (
							'class' => 'add',
							'target' => 'navtab',
							'rel' => 'wishproductsellerrelation-grid',
...
function bindSkuSellerDownCSV(){
    ...
    var url ='/wish/wishproductsellerrelation/bindsellerexportxls?' + request;
    var ajaxurl ='/wish/wishproductsellerrelation/bindsellerexportxlsajax?' + request;
    var checkType = 0;
