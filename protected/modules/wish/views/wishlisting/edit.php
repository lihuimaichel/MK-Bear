        ...
        <div class="dot7" style="padding:5px;">
            <div class="row productAddInfo" style="width:90%;float:left;">
                ...
                $form = $this->beginWidget('ActiveForm', array(
                    ...
                    'action' => Yii::app()->createUrl('wish/wishlisting/saveEdit'),
                    'htmlOptions' => array(
                        'class' => 'pageForm',
                    )
                ));
                ?>
                <input type="hidden" name="id" value="<?php echo $skuInfo['id']?>">
                                        ...
                                        <tr id="attr_<?php echo $val['product_id']; ?>"
                                            ...
                                            <td>
                                                <div class="upload_status_show">
                                                    <?php echo WishListing::model()->getWishProductVariantStatusText($val['enabled']); ?>
                                                </div>
                                            </td>
                                            <td>
