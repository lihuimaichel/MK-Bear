            ...
            <li>
                <div class="buttonActive">
                    <div class="buttonContent">
                        <a rel="" href="<?php echo Yii::app()->createUrl('aliexpress/aliexpressproductadd/step2');?>" target="navTab" id="product_add_next_btn" style="display:none;">
...
$('#product_add_next_btn').click(function(){
	$(this).attr('href','aliexpress/aliexpressproductadd/step2/publish_sku/'+$('#product_add_sku').val());
	$('.dialog .close').click();
});
</script>
<?php else: ?>
