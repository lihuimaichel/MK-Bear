...
<?php
    $form = $this->beginWidget('ActiveForm', array(
        ...
        'action' => '/aliexpress/aliexpressaccountseller/add',
        'htmlOptions' => array(        
            'class' => 'pageForm',         
        )
    ));
    ...
    <div class="pageFormContent" layoutH="56"> 
        <div class="pd5" style="height:120px;">
        	...
        	<div class="row" id="accountListAll">
                ...
                <span><input name="AliexpressAccountSeller[account_id][]" type="checkbox" value="<?php echo $id; ?>" /><?php echo $accout; ?></span>
                <?php endforeach;?>
                <?php endif;?>
        	</div>
...
$(document).ready(function(){
    //触发了要发布的账号
    $("#AliexpressAccountSeller_seller_user_id").change(function(){
        var selectedId = $(this).find("option:selected").val();
        var ajaxurl ='/aliexpress/aliexpressaccountseller/ajaxdata/seller_id/' + selectedId;
