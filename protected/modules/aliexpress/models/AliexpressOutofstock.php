 ...
 * @since 2016-12-07
 */
class AliexpressOutofstock extends AliexpressModel{
    ...
    public function tableName() {
        return 'ueb_aliexpress_outofstock';
    }
...
// ================= ebay Listing Search =====================
    ...
    public function filterOptions() {
        ...
        $result = array(
                ...
                array(
                    'name'          => 'operator',
                    'type'          => 'dropDownList',
                    'data'          => User::model()->getEmpByDept(array(3, 23, 19)),
                    'value'         => 1,
                    'search'        => '=',
                    'htmlOptions'   => array(),
                    'rel'           => 'selectedTodo',
    ...
    public function setSearchDbCriteria(){
        ...
        //联接ebay多属性表
        $cdbcriteria->join = "right join ueb_aliexpress_product_variation as v on v.sku = t.sku ";
