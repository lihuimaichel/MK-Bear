 ...
 * 设置销售人员销售额任务
 */
class AliexpressSalesTarget extends AliexpressModel
{
	const TARGET = 50000;
	...
	{
		return 'ueb_aliexpress_task_sales_target';
	}

	public function deleteOne($uid, $account_id, $site)
	{
		$result = Yii::app()->db_aliexpress->createCommand()
			->delete(
				$this->tableName(),
	...
	protected function _setCDbCriteria()
	{
		...
		$department_id = !empty($department_id) ? $department_id : 4;
	...
	{
		$list = Yii::app()->db_aliexpress->createCommand()
	...
	{
		$rows = AliexpressSalesExtend::model()->getDataByCondition('*', " sales_id = '{$id}'");
		return $rows;
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'account_id' => Yii::t('tast', 'Accounts'),
