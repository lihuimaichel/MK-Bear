...
class JoomAccountSeller extends JoomModel{
    ...
    public function tableName() {
        return 'ueb_joom_account_seller';
    }
    ...
    private function _additions($datas){
    	if($datas){
    		$aliexpressAccountList = UebModel::model("JoomAccount")->getIdNamePairs();
    ...
    public function filterOptions(){
    	return array(
    			...
    			array(
    					'name'		=>	'seller_user_id',
    					'type'		=>	'dropDownList',
    					'data'		=>	User::model()->getUserNameByDeptID(37),
    					'search'	=>	'=',
    			),
    	);
    }
    ...
    public static function getIndexNavTabId() {
        return Menu::model()->getIdByUrl('/joom/joomaccountseller/list');
    }
