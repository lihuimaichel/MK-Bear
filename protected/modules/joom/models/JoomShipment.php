...
class JoomShipment extends JoomModel {
	 ...
	 * @return	array
	 */
	public function getJoomPostOrderList($packageID,$shipCodes=array()) {
		if (empty($shipCodes)) {
			$shipCodes = array('cm_joom','ghxb_joom');
		}
		...
		$obj = $this->dbConnection->createCommand()
			...
			->where('O.platform_code = "'.Platform::CODE_JOOM.'" ')	//and O.account_id = 17
