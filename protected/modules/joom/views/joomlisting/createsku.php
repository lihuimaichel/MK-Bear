        	 ...
        	 <li>
        		<div class="buttonActive">
                    <div class="buttonContent">                        
                        <button type="submit" id="joom_listing_encrypt_sku"><?php echo Yii::t('joom_listing', 'Encry SKU')?></button>                       
                    </div>
                </div>
       	    </li>             	
            <li>
...
$(function(){
	$("#joom_listing_encrypt_sku").click(function(){
		var sku = $(".dataintable_inquire").find("input[name='sku']").val();
		var param = {'sku':sku};
		var url = '<?php echo Yii::app()->createUrl("joom/joomlisting/createencrysku");?>';
