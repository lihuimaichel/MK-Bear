 ...
 * Time: 10:38
 */
class LazadaListingOptimization extends LazadaModel
{
	...
	{
		return 'ueb_lazada_task_listing_optimization';
	}
	...
	public function sellerAccountSiteList($sellers = array(), $all_site = true)
	{
        ...
        (false == $all_site) ? $cmd->andWhere(" `status` = 1 ") : " ";
        $list = $cmd->order("id DESC")
			    ->queryAll();
		return $list;
	}
	...
	public function filterOptions()
	{
		$filterData = array(
			array(
				'name' => 'account_id',
				'type' => 'dropDownList',
				'data' => LazadaAccount::getIdNamePairs(),
				'search' => '=',
				'alis' => 'p'
			),
		);
