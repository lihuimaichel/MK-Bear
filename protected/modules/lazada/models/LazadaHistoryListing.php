...
class LazadaHistoryListing extends LazadaModel
{
	const TABLE_NAME = 'ueb_lazada_task_history_listing';
	...
	{
		$wait_table = LazadaWaitListing::TABLE_NAME;
	...
	{
		$product_table = UebModel::model('LazadaProductAdd')->tableName();
	...
	{
		return LazadaWaitListing::TABLE_NAME;
	}
