...
?>  
    <div class="pageFormContent" layoutH="80">  
         ...
         <div class="row">
         	...
         	<div class="contents">
         		<ul>
         			<li><input id="select_all" type="checkbox" name="select_all" value="" /><span><?php echo Yii::t('aliexpress_product', 'Select All');?></span></li>
		          	<?php foreach ($account_list as $row) { ?>
		          	<li>
		         	<input id="account_id_<?php echo $row['id'];?>" type="checkbox" name="account_id[]" value="<?php echo $row['id'];?>" /><label for="account_id_<?php echo $row['id'];?>"><?php echo $row['seller_name'] . '-' . LazadaSite::getSiteShortName($row['site_id']);?></label>
		         	</li>
		         	<?php } ?>
         		</ul>
         	</div>
