...
<script type="text/javascript">
    ...
    function loadFillInfoByCategory(){
        ...
        var site_id = <?php echo $listingProduct['site_id']; ?>;

        var edit_id = <?php echo $listingProduct['id']; ?>;
        ...
        if( categoryID > 0 ){
            ...
            $.ajax({
                ...
                data:{category_id:categoryID, sku:'<?php echo $listingProduct['sku'];?>', accounts:accounts.join(), site_id:site_id, listing_type:listing_type,edit_id:edit_id},
                success:function(result){
                                    ...
                                    if(listing_type == list_type ){
                                        ...
                                        if (result.variation_info != undefined ) {
                                                ...
                                                //子sku自动填充
                                                variation_html += '<td><input style="line-height:20px;font-size:20px" type="text"  class="text_sku"  name="variationSku[]" value="' + detail.sku + '" /><input type="hidden" name="variationColor[]" value="' + detail.color_id + '"/><input type="hidden" name="variationID[]" value="' + detail.variation_id + '"/></td>';                                                                                        
    ...
    function loadPriceInfo(self){
        $.ajax({
            ...
            data:{
                ...
                price:$(self).val(),
                site_id:<?php echo $listingProduct['site_id']; ?>
            },
            success:function(result){
