            ...
            <li>
                <div class="buttonActive">
                    <div class="buttonContent">
                        <a rel="" href="<?php echo Yii::app()->createUrl('lazada/lazadayproductadd/productaddstepsecond');?>" target="navTab" id="product_add_next_btn" style="display:none;">
                            <?php echo Yii::t('lazada', 'Choose Add Info')?>
                        </a>
                    </div>
                </div>
            </li>
...
$('#product_add_next_btn').click(function(){
	$(this).attr('href','lazada/lazadaproductadd/productaddstepsecond/sku/'+$('#product_add_sku').val());
	$('.dialog .close').click();
});
</script>
<?php else: ?>
<div id="lazada_product_add_step2"></div>
<script>
	$(function(){
		$.pdialog.open(
