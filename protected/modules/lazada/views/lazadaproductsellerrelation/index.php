...
$row = 0;
$options = array(
	'id' => 'lazadaproductsellerrelation-grid',
	...
	'toolBar' => array(
			array (
					...
					'htmlOptions' => array (
							'class' => 'add',
							'target' => 'dialog',
							'rel' => 'lazadaproductsellerrelation-grid',
							'postType' => '',
							'callback' => '',
							'height' => '480',
							'width' => '650'
			...
			array (
					...
					'url' => '/lazada/lazadaproductsellerrelation/batchchangetoseller',
					'htmlOptions' => array (
							'class' => 'add',
							'target' => 'dialog',
							'rel' => 'lazadaproductsellerrelation-grid',
			...
			array (
					...
					'url' => '/lazada/lazadaproductsellerrelation/batchdel',
					'htmlOptions' => array (
							'class' => 'delete',
							'target' => 'selectedToDo',
							'rel' => 'lazadaproductsellerrelation-grid',
			...
			array (
					...
					'url' => '/lazada/lazadaproductsellerrelation/unbindseller',
					'htmlOptions' => array (
							'class' => 'add',
							'target' => 'navtab',
							'rel' => 'lazadaproductsellerrelation-grid',
	...
	'columns'=>array(
			...
			/* array(
				...
				array(
					...
					'buttons' => array(
							'edit' => array(
									'url'       => 'Yii::app()->createUrl("/lazada/lazadaproductsellerrelation/update", array("id" => $data->id))',
									'label'     => Yii::t('lazada_listing', '修改'),
									'options'   => array(
											'target'    => 'dialog',
											'class'     => 'btnEdit',
											'rel' 		=> 'lazadaproductsellerrelation-grid',
...
function bindSkuSellerDownCSV(){
    ...
    var url ='/lazada/lazadaproductsellerrelation/bindsellerexportxls?' + request;
    var ajaxurl ='/lazada/lazadaproductsellerrelation/bindsellerexportxlsajax?' + request;
    var checkType = 0;
