            ...
            <li>
                <div class="buttonActive">
                    <div class="buttonContent">
                        <a rel="" href="<?php echo Yii::app()->createUrl('amazon/amazonproductadd/step2');?>" target="navTab" id="product_add_next_btn" style="display:none;">
                            <?php echo Yii::t('amazon_product', 'Choose Add Info')?>
                        </a>
                    </div>
                </div>
            </li>
...
$('#product_add_next_btn').click(function(){
	$(this).attr('href','amazon/amazonproductadd/step2/publish_sku/'+$('#product_add_sku').val());
	$('.dialog .close').click();
});
</script>
<?php else: ?>
<div id="lazada_product_add_step1"></div>
<script>
	$(function(){
		$.pdialog.open(
	    		'<?php echo Yii::app()->createUrl($this->route, array('dialog'=>1)) ?>', 
	    		'1',
	    		'<?php echo Yii::t('amazon_product','Please input SKU');?>',
