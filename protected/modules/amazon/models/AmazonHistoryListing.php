...
class AmazonHistoryListing extends AmazonModel
{
	const TABLE_NAME = 'ueb_amazon_task_history_listing';
	...
	{
        $site_list = array_flip(AmazonSite::getSiteList());
        $country_code = $params['country_code'];
	    $site_id = isset($site_list[$country_code]) ? $site_list[$country_code] : 0;
	...
	{
		$wait_table = AmazonWaitListing::TABLE_NAME;
	...
	{
		$product_table = UebModel::model('AmazonProductAdd')->tableName();
	...
	{
		return AmazonWaitListing::TABLE_NAME;
	}
