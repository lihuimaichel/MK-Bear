<?php
class OrderGiftLogAmazon extends OrdersModel {
	...
	public function tableName() {
		return 'ueb_order_gift_log_amazon';
	}
	...
	/**
	 * @desc 根据批量的orderid查看该订单是否有分配过gift
	 */
	public function checkGiftIsOrNotBatch( $orderIdStr ){
		if( $orderIdStr ){
			$giftInfos = $this->getDbConnection()->createCommand()
						->select( 'order_id' )
						->from( self::tableName() )
