...
$this->widget('UGridView', array(
	...
	'toolBar' => array(
		array(
			...
			'url' => Yii::app()->createUrl('jd/jdproductstatistic/batchpublish/', array( 'account_id' => $accountID)),
			'htmlOptions' => array(
				'class' => 'add',
				'target' => 'selectedTodo',
				'rel' => 'jd_product_statistic',
				'postType' => 'string',
				'callback' => 'navTabAjaxDone',
				'title' => Yii::t('jd', 'Are You Sure to Publish?'),
				'onclick' => '',
			),
		),			
	),
