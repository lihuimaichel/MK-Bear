 ...
 * @since 2017-02-28
 */ 
class PaytmLog extends PaytmModel{
	...
	/** @var 拉取产品列表*/
    const EVENT_GETPRODUCT = 'getproduct';
    ...
    public function getAccountList(){
            if(self::$accountPairs == null)
                    self::$accountPairs = self::model('PaytmAccount')->getIdNamePairs();
