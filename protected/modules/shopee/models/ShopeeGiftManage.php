<?php
/**
 * @desc ShopeeGiftManage
 * @author Yangsh
 * @since 2017-03-22
 */
class ShopeeGiftManage extends ShopeeModel{
    ...
    {
        return Menu::model()->getIdByUrl('/shopee/shopeegiftmanage/list');
    }
    ...
    public static function getAccountList() {
        $accountList = ShopeeAccount::model()->getListByCondition("id,short_name","status=1","site asc");
