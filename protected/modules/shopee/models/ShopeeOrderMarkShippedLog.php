<?php
/**
 * @desc Shopee 记录订单确认发货信息
 * @since	2015-10-12
 */

class ShopeeOrderMarkShippedLog extends ShopeeModel {
	...
	const UPLOAD_ERROR_MAX_COUNT = 5;//最大上传失败次数
	...
	public function tableName() {
		return 'ueb_shopee_order_markshipped_log';
	}
	...
	public function getWaitingMarkShipOrder($accountId){
		...
		$ret = $dbCommand
				...
				->andWhere('error_type=0 or error_type=99')
				->queryAll();
