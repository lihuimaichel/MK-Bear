<?php
/**
 * @desc BulkMark Shipped Request
 * @author yangsh
 * @since 2017-03-30
 */
class BulkMarkShippedRequest extends PaytmApiAbstract {
    ...
    public function setEndPoint() {
        $this->_endpoint = 'v1/merchant/'.$this->_merchantID.'/fulfillment/bulkmarkshipped?authtoken='.$this->_accessToken.'&fulfillment_ids='.implode(',',$this->_fulfillmentIds);
    }       
