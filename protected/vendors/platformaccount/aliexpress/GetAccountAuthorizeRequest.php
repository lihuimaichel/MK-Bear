...
class GetAccountAuthorizeRequest extends AliexpressApiAbstract{ 
    ...
    public function setRequest(){
    	$str = 'client_id'.$this->_appKey.'redirect_uri'.$this->_redirect_uri.'site'.$this->site.'state'.$this->accountID;
        ...
        $request['_url']=$this->_baseUrl.'client_id='.$this->_appKey.'&site='.$this->site.'&state='.$this->accountID.'&redirect_uri='.$this->_redirect_uri.'&_aop_signature='.$request['_aop_signature'];
