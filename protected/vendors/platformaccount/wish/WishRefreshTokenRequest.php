<?php
class WishRefreshTokenRequest extends WishApiAbstract {
	...
	public function setAccount($accountID){
		...
		//获取账号相关信息
		$accountInfo = PlatformWishAccount::getWishAccountInfoById($this->accountID);
		...
		$this->_tokenExpiredTime = strtotime($accountInfo['token_invalid_time']);
