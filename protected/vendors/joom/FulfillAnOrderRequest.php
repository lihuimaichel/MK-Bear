 ...
 *
 */
class FulfillAnOrderRequest extends JoomApiAbstract{
	...
	public function setRequest() {
		...
		if(isset($_REQUEST['bug']) && isset($_REQUEST['bug'])){
	...
	public function setEndpoint() {
		parent::setEndpoint('order/fulfill-one', true);
	}
