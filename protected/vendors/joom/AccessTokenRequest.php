 ...
 *
 */
class AccessTokenRequest extends JoomApiAbstract {
	...
	public function sendRequest() {
		try {
			$this->setUrl();
			$response = Yii::app()->curl->addCertificate()->post($this->_url, $this->getRequestBody());//添加证书
	...
	public function setEndpoint(){
		parent::setEndpoint('oauth/access_token', true);
	}	
